<div class="modal fade" id="confirm<?php echo $row['Order_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid text-center">
          คุณต้องการยืนยันการสั่งซื้อ : <strong><?php echo $drow['Product_name']; ?></strong> ใช่หรือไม่
        </div>
      </div>
...
<div class="modal fade" id="cancle<?php echo $row['Order_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
        <a href="cancleorder.php?Order_id=<?php echo $row['Order_id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Confirm</a>
      </div>
    </div>
  </div>
</div>